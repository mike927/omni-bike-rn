...
export function BikeIcon({ size = 104 }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      />
      <Path stroke={noir.ink} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.5h6" />
      <Path stroke={noir.ink} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" d="m4.5 7.5 3 4.5" />
    </Svg>
  );
}
